                ...
                @foreach ($videos as $index => $video)
                    <tr onclick="window.location='{{ route('videos.manage.show', $video) }}';"
                        ...
                        <td class="py-4 px-2 text-center space-y-2">
                            <a href="{{ route('videos.manage.edit', $video) }}" class="block bg-blue-600 text-white px-4 py-2 rounded text-sm hover:bg-blue-500 transition duration-200">Editar</a>
                            <a href="{{ route('videos.manage.delete', $video) }}" class="block bg-red-600 text-white px-4 py-2 rounded text-sm hover:bg-red-500 transition duration-200">Eliminar</a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
