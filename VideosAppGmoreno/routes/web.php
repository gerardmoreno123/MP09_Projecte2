...
use App\Http\Controllers\Videos\VideoNotificationController;
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // Gestio de sèries per a regular usuaris
    Route::get('/series/create', [SeriesController::class, 'create'])->name('series.create');
    Route::post('/series', [SeriesController::class, 'store'])->name('series.store');
    Route::get('/series/{serie}/edit', [SeriesController::class, 'edit'])->name('series.edit')->where('serie', '[0-9]+');
    Route::put('/series/{serie}', [SeriesController::class, 'update'])->name('series.update')->where('serie', '[0-9]+');
    Route::get('/series/{serie}/delete', [SeriesController::class, 'delete'])->name('series.delete')->where('serie', '[0-9]+');
    Route::delete('/series/{serie}', [SeriesController::class, 'destroy'])->name('series.destroy')->where('serie', '[0-9]+');
});
